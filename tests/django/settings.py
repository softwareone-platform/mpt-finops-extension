...
MPT_API_BASE_URL = os.getenv("MPT_API_BASE_URL", "https://api.s1.show")
MPT_API_TOKEN = os.getenv(
    "MPT_API_TOKEN")
...
EXTENSION_CONFIG = {
    ...
    "DUE_DATE_DAYS": "30",
    "FFC_OPERATIONS_API_BASE_URL": "https://api.finops.s1.show",
    "FFC_SUB": "my_sub",
